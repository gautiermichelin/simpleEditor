 ...
 */
	...
	require_once(__CA_MODELS_DIR__.'/ca_loan_labels.php');
 	require_once(__CA_MODELS_DIR__.'/ca_locales.php');


	require_once(__CA_LIB_DIR__."/ca/Search/LoanSearch.php");
	require_once(__CA_LIB_DIR__."/ca/Search/LoanSearchResult.php");
	...
	class LoansController extends SimpleEditorBaseController {
 		# -------------------------------------------------------
  		protected $opo_config;		// plugin configuration file
		protected $ops_table_name = 'ca_loans';		// name of "subject" table (what we're editing)
		protected $ops_cookie_prefix = 'simpleEditorLoanControllerLastEdited_';		// cookie prefix eventually followed by record type
		protected $ops_record_id = 'loan_id';		// name of "subject" table (what we're editing)
		protected $ops_table_propername = "Loans";
		protected $ops_table_type_list = 'loan_types';
