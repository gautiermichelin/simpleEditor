...
class SimpleEditorBaseController extends ActionController {
	...
	public function Edit($pa_values=null, $pa_options=null) {
		...
		if (((int) $_COOKIE[$this->ops_cookie_prefix]>0) && (!$vn_record_id)) {
			$vn_lastedited_record_id = $_COOKIE[$this->ops_cookie_prefix];
		...
		if($vn_record_id) {
			...
			setcookie($this->ops_cookie_prefix, $vn_record_id, time()+3600*24*30,"/");
