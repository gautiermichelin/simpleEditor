...
require_once(__CA_MODELS_DIR__.'/ca_object_representations_x_collections.php');
require_once(__CA_MODELS_DIR__.'/ca_locales.php');


require_once(__CA_LIB_DIR__."/ca/Search/CollectionSearch.php");
require_once(__CA_LIB_DIR__."/ca/Search/CollectionSearchResult.php");
...
class CollectionsController extends SimpleEditorBaseController {
	# -------------------------------------------------------
	...
	public function __construct(&$po_request, &$po_response, $pa_view_paths=null) {
		...
		$this->ops_table_name="ca_collections";
	...
	public function Edit($pa_values=null, $pa_options=null) {
		...
		if($vn_subject_id) {
			...
			setcookie("simpleEditorCollectionsControllerLastEdited", $vn_subject_id, time()+3600*24*30,"/");
		} elseif ((int) $_COOKIE["simpleEditorCollectionsControllerLastEdited"]>0) {
			$vn_subject_id = $_COOKIE["simpleEditorCollectionsControllerLastEdited"];
			$url = "/".str_ireplace("//","", str_ireplace("/collection_id/","",$this->getRequest()->getRequestUrl()))."/collection_id/".$vn_subject_id;
			$this->redirect($url);
		} else {
		...
		if ($vn_subject_id) {
			...
			$vt_item = new ca_collections($vn_subject_id);
