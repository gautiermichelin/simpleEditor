 ...
 */
	...
	class LoansAjaxController extends SimpleEditorCommonAjaxController
	{
		...
		public function __construct(&$po_request, &$po_response, $pa_view_paths = null)
		{
			...
			$this->ops_table_name = 'ca_loans';        // name of "subject" table (what we're editing)
			$this->ops_list_type_id = 'loan_types';
			$this->ops_table_field_id = 'loan_id';
		}
	}