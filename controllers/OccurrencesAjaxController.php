 ...
 */
	...
	class OccurrencesAjaxController extends SimpleEditorBaseAjaxController {
		...
		public function __construct(&$po_request, &$po_response, $pa_view_paths = null)
		{
 		...
 		public function DownloadAttributeFile($pa_options=null) {
			...
			$this->response->setRedirect(str_replace("simpleEditor/OccurrencesAjax", "editor/occurrences/OccurrenceEditor", $url));
			return;
		}		
